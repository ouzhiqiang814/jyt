 ...
 * 线索审批
 */
angular.module('approveclue.controller', [])
    .controller('ApproveclueCtrl', function ($scope, $state, GlobalVariable, $ionicBackdrop, $window, $timeout, $ionicHistory, $ionicPopup, $rootScope, $ionicLoading) {
