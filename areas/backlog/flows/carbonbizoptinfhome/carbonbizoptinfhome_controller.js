 ...
 * 线索审批
 */
angular.module('carbonbizoptinfhome.controller', [])
    .controller('CarbonbizoptinfhomeCtrl', function ($scope, $state, GlobalVariable, $ionicBackdrop, $window, $timeout, $ionicHistory, $ionicPopup, $rootScope, $ionicLoading) {
