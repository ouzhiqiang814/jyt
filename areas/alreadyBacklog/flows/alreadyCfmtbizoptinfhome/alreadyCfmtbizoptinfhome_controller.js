 ...
 * 机会认定
 */
angular.module('alreadyCfmtbizoptinfhome.controller', [])
    .controller('AlreadyCfmtbizoptinfhomeCtrl', function ($scope, $state, $ionicLoading, GlobalVariable, $ionicBackdrop, $window, $timeout, $ionicHistory,$ionicPopup,$rootScope) {
        ...
        $scope.activityId = approveItem.myActivityId;
       ...
       //
        ...
        $scope.cfmBizOptInf = function(param){
            ...
            AjaxJsonp(SysServiceData('CPC', 'commitbizoptinf', [jsonToXml(requestData), jsonToXml(person)]), url.cpc, function (responseVO) {
                hide($ionicLoading);
