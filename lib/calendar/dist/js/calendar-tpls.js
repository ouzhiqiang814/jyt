...
angular.module("templates/rcalendar/monthviewEventDetail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/rcalendar/monthviewEventDetail.html",
    ...
    "            <td class=\"event-detail ow-table-type\">{{::event.title}}</td>\n" +
    "            <td class=\"event-detail ow-table-info\">{{::event.info}}</td>\n" +
    "            <td class=\"ow-success-push\" ng-if=\"event.pushState\"><i class=\"icon ion-checkmark-round\"></i></td>\n" +
    "            <td class=\"ow-fail-push\" ng-if=\"!event.pushState\"><i class=\"icon ion-android-warning\"></i></td>\n" +
    "        </tr>\n" +
